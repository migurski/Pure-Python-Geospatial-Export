...
class TestGeospatialExport(unittest.TestCase):
    ...
    def test_1_bigquery_csv_to_geopackage(self):
        ...
        process_bigquery_to_geopackage(self.bigquery_csv, output_path, "test_table")
    ...
    def test_2_snowflake_csv_to_geopackage(self):
        ...
        process_snowflake_to_geopackage(self.snowflake_csv, output_path, "test_table")
    ...
    def test_3_bigquery_csv_to_shapefile(self):
        ...
        process_bigquery_to_shapefile(self.bigquery_csv, output_path)
    ...
    def test_4_snowflake_csv_to_shapefile(self):
        ...
        process_snowflake_to_shapefile(self.snowflake_csv, output_path)
